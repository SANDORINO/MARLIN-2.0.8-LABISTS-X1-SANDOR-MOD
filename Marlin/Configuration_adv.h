 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  16               // Seconds /// SANDOR MOD LABISTS X1 ///
  #define WATCH_TEMP_INCREASE 4               // Degrees Celsius /// SANDOR MOD LABISTS X1 ///
#endif
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        60 // Seconds /// SANDOR MOD BED ///
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                120 // Seconds /// SANDOR MOD BED ///
 ...
 */
#define HOTEND_IDLE_TIMEOUT /// SANDOR MOD ///
#if ENABLED(HOTEND_IDLE_TIMEOUT)
  #define HOTEND_IDLE_TIMEOUT_SEC (3*60)    /// SANDOR MOD /// // (seconds) Time without extruder movement to trigger protection
...
#define HOMING_BUMP_MM      { 5, 5, 5 }       // (mm) Backoff from endstops after first bump /// SANDOR MOD LABISTS X1 ///
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

//#define HOMING_BACKOFF_POST_MM { 2, 2, 2 }  // (linear=mm, rotational=°) Backoff from endstops after homing

 #define QUICK_HOME                          // If G28 contains XY do a diagonal move first /// SANDOR MOD LABISTS X1 ///
 ...
 */
#define DEFAULT_STEPPER_DEACTIVE_TIME 60 /// SANDOR MOD LABISTS X1 ///
...
//
#define BACKLASH_COMPENSATION /// SANDOR MOD ??? ///
  ...
  //#define BACKLASH_GCODE /// SANDOR MOD LABISTS X1 ///
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING /// SANDOR MOD ///
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 30*60, 30*60, 10*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel /// SANDOR MOD LABISTS X1 ///
...
// LCD Print Progress options
  ...
  #define NO_SD_AUTOSTART                 // Remove auto#.g file support completely to save some Flash, SRAM /// SANDOR MOD ??? ///
   ...
   */
  #define SDCARD_CONNECTION ONBOARD /// SANDOR MOD /// 
...
#define USE_WATCHDOG /// ??? ///
  ...
  //#define WATCHDOG_RESET_MANUAL  /// SANDOR MOD V3 ??? ///
#endif
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                   // Requires ~3226 bytes  /// SANDOR MOD ///
 ...
 */
#define DIRECT_STEPPING /// SANDOR MOD ??? ///
 ...
 */
#define EMERGENCY_PARSER /// SANDOR MOD ??? ///
...
#define EXPERIMENTAL_I2CBUS  // SANDOR MOD V3
